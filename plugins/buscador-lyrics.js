...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  if (!teks) throw `> ⓘ *Ingrese algun nombre de la musica, por ejemplo: ${usedPrefix + command} Billie Eilish*`;
  try {
