...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} obtienes: +1209 de exp` : isTie ? '> ⓘ El juego termino siendo empatados...' : `> ⓘ Es tu turno @${room.game.currentTurn.split('@')[0]}`}
`.trim();
