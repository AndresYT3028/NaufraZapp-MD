...
**/
    ...
    const htextos = `${text ? text : '*ERROR, NO FUE POSIBLE COPIAR EL TEXTO.*'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://github.com/Bots-WhatsApp-OFC/NaufraZapp-MD'}}}}}, {});
    }
  }
};
